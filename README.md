...
| Policy | Description |
| --- | --- |
| [AWSDirectConnectReadOnlyAccess](./policies/AWSDirectConnectReadOnlyAccess.md) | Provides read only access to AWS Direct Connect via the AWS Management Console. | 
| [AmazonGlacierReadOnlyAccess](./policies/AmazonGlacierReadOnlyAccess.md) | Provides read only access to Amazon Glacier via the AWS Management Console. | 
| [AWSMarketplaceFullAccess](./policies/AWSMarketplaceFullAccess.md) | Provides the ability to subscribe and unsubscribe to AWS Marketplace software, allows users to manage Marketplace software instances from the Marketplace 'Your Software' page, and provides administrative access to EC2. | 
| [ClientVPNServiceRolePolicy](./policies/ClientVPNServiceRolePolicy.md) | Policy to enable AWS Client VPN to manage your Client VPN endpoints. | 
| [AWSSSODirectoryAdministrator](./policies/AWSSSODirectoryAdministrator.md) | Administrator access for SSO Directory | 
| [AWSIoT1ClickReadOnlyAccess](./policies/AWSIoT1ClickReadOnlyAccess.md) | Provides read only access to AWS IoT 1-Click. | 
| [AutoScalingConsoleReadOnlyAccess](./policies/AutoScalingConsoleReadOnlyAccess.md) | Provides read-only access to Auto Scaling via the AWS Management Console. | 
| [AmazonDMSRedshiftS3Role](./policies/AmazonDMSRedshiftS3Role.md) | Provides access to manage S3 settings for Redshift endpoints for DMS. | 
| [AWSQuickSightListIAM](./policies/AWSQuickSightListIAM.md) | Allow QuickSight to list IAM entities | 
| [AWSHealthFullAccess](./policies/AWSHealthFullAccess.md) | Allows full access to the AWS Health Apis and Notifications and the Personal Health Dashboard | 
| [AlexaForBusinessGatewayExecution](./policies/AlexaForBusinessGatewayExecution.md) | Provide gateway execution access to AlexaForBusiness services | 
| [AmazonElasticTranscoder_ReadOnlyAccess](./policies/AmazonElasticTranscoder_ReadOnlyAccess.md) | Grants users read-only access to Elastic Transcoder and list access to related services. | 
| [AmazonRDSFullAccess](./policies/AmazonRDSFullAccess.md) | Provides full access to Amazon RDS via the AWS Management Console. | 
| [SupportUser](./policies/SupportUser.md) | This policy grants permissions to troubleshoot and resolve issues in an AWS account. This policy also enables the user to contact AWS support to create and manage cases. | 
| [AmazonEC2FullAccess](./policies/AmazonEC2FullAccess.md) | Provides full access to Amazon EC2 via the AWS Management Console. | 
| [SecretsManagerReadWrite](./policies/SecretsManagerReadWrite.md) | Provides read/write access to AWS Secrets Manager via the AWS Management Console. Note: this exludes IAM actions, so combine with IAMFullAccess if rotation configuration is required. | 
| [AWSIoTThingsRegistration](./policies/AWSIoTThingsRegistration.md) | This policy allows users to register things at bulk using AWS IoT StartThingRegistrationTask API | 
| [AmazonDocDBReadOnlyAccess](./policies/AmazonDocDBReadOnlyAccess.md) | Provides read-only access to Amazon DocumentDB with MongoDB compatibility. Note that this policy also grants access to Amazon RDS and Amazon Neptune resources. | 
| [AmazonMQApiFullAccess](./policies/AmazonMQApiFullAccess.md) | Provides full access to AmazonMQ via our API/SDK. | 
| [AWSElementalMediaStoreReadOnly](./policies/AWSElementalMediaStoreReadOnly.md) | Provides read-only permissions for MediaStore APIs | 
| [AWSCertificateManagerReadOnly](./policies/AWSCertificateManagerReadOnly.md) | Provides read only access to AWS Certificate Manager (ACM). | 
| [AWSQuicksightAthenaAccess](./policies/AWSQuicksightAthenaAccess.md) | Quicksight access to Athena API and S3 buckets used for Athena query results | 
| [AWSCloudMapRegisterInstanceAccess](./policies/AWSCloudMapRegisterInstanceAccess.md) | Provides registrant level access to AWS Cloud Map actions. | 
| [AWSMarketplaceImageBuildFullAccess](./policies/AWSMarketplaceImageBuildFullAccess.md) | Provides full access to AWS Marketplace Private Image Build Feature. In addition to create private images, it also provides permissions to add tags to images, launch and terminate ec2 instances. | 
| [AWSCodeCommitPowerUser](./policies/AWSCodeCommitPowerUser.md) | Provides full access to AWS CodeCommit repositories, but does not allow repository deletion. | 
| [AWSCodeCommitFullAccess](./policies/AWSCodeCommitFullAccess.md) | Provides full access to AWS CodeCommit via the AWS Management Console. | 
| [IAMSelfManageServiceSpecificCredentials](./policies/IAMSelfManageServiceSpecificCredentials.md) | Allows an IAM user to manage their own Service Specific Credentials. | 
| [AmazonEMRCleanupPolicy](./policies/AmazonEMRCleanupPolicy.md) | Allows the actions that EMR requires to terminate and delete AWS EC2 resources if the EMR Service role has lost that ability. | 
| [AWSCloud9EnvironmentMember](./policies/AWSCloud9EnvironmentMember.md) | Provides the ability to be invited into AWS Cloud9 shared development environments. | 
| [AWSApplicationAutoscalingSageMakerEndpointPolicy](./policies/AWSApplicationAutoscalingSageMakerEndpointPolicy.md) | Policy granting permissions to Application Auto Scaling to access SageMaker and CloudWatch. | 
...
| [AWSOpsWorksCMInstanceProfileRole](./policies/AWSOpsWorksCMInstanceProfileRole.md) | Provides S3 access for instances launched by OpsWorks CM. | 
...
| [ServerMigrationServiceLaunchRole](./policies/ServerMigrationServiceLaunchRole.md) | Permissions to allow the AWS Server Migration Service to create and update relevant AWS resources into the customer's AWS account for launching migrated servers and applications. | 
...
| [AWSDataPipeline_PowerUser](./policies/AWSDataPipeline_PowerUser.md) | Provides full access to Data Pipeline, list access for S3, DynamoDB, Redshift, RDS, SNS, and IAM roles, and passRole access for default Roles. | 
...
| [AWSConfigRole](./policies/AWSConfigRole.md) | Default policy for AWS Config service role. | 
...
| [AmazonMachineLearningRealTimePredictionOnlyAccess](./policies/AmazonMachineLearningRealTimePredictionOnlyAccess.md) | Grants users permission to request Amazon Machine Learning real-time predictions. | 
...
| [GlobalAcceleratorFullAccess](./policies/GlobalAcceleratorFullAccess.md) | Allow GlobalAccelerator Users full Access to all APIs | 
...
| [AmazonECS_FullAccess](./policies/AmazonECS_FullAccess.md) | Provides administrative access to Amazon ECS resources and enables ECS features through access to other AWS service resources, including VPCs, Auto Scaling groups, and CloudFormation stacks. | 
...
| [AWSQuickSightIoTAnalyticsAccess](./policies/AWSQuickSightIoTAnalyticsAccess.md) | Give QuickSight read-only access to IoT Analytics datasets | 
...
| [ApplicationDiscoveryServiceContinuousExportServiceRolePolicy](./policies/ApplicationDiscoveryServiceContinuousExportServiceRolePolicy.md) | Enables access to AWS Services and Resources used or managed by Application Discovery Service Continuous Export feature | 
...
| [AWSSecurityHubServiceRolePolicy](./policies/AWSSecurityHubServiceRolePolicy.md) | A service-linked role required for AWS Security Hub to access your resources. | 
...
| [AWSLambdaVPCAccessExecutionRole](./policies/AWSLambdaVPCAccessExecutionRole.md) | Provides minimum permissions for a Lambda function to execute while accessing a resource within a VPC - create, describe, delete network interfaces and write permissions to CloudWatch Logs.  | 
...
| [AWSGlueSchemaRegistryReadonlyAccess](./policies/AWSGlueSchemaRegistryReadonlyAccess.md) | Provides readonly access to the AWS Glue Schema Registry Service | 
...
| [AmazonLookoutVisionFullAccess](./policies/AmazonLookoutVisionFullAccess.md) | Provides full access to Amazon Lookout for Vision and scoped access to required dependencies. | 
...
| [AWSGlobalAcceleratorSLRPolicy](./policies/AWSGlobalAcceleratorSLRPolicy.md) | Policy granting permissions to AWS Global Accelerator to manage EC2 Elastic Network Interfaces and Security Groups.  | 
...
| [AmazonElasticFileSystemServiceRolePolicy](./policies/AmazonElasticFileSystemServiceRolePolicy.md) | Allows Amazon Elastic File System to manage AWS resources on your behalf | 
...
| [AmazonWorkDocsFullAccess](./policies/AmazonWorkDocsFullAccess.md) | Provides full access to Amazon WorkDocs via the AWS Management Console | 
| [AmazonHoneycodeWorkbookReadOnlyAccess](./policies/AmazonHoneycodeWorkbookReadOnlyAccess.md) | Provides read only access to Honeycode Workbook via the AWS Management Console and the SDK. | 
| [MediaPackageServiceRolePolicy](./policies/MediaPackageServiceRolePolicy.md) | Allows MediaPackage to publish logs to CloudWatch | 
| [IAMAccessAnalyzerReadOnlyAccess](./policies/IAMAccessAnalyzerReadOnlyAccess.md) | Provides read only access to IAM Access Analyzer resources | 
| [AmazonEventBridgeSchemasServiceRolePolicy](./policies/AmazonEventBridgeSchemasServiceRolePolicy.md) | Grants permissions to Managed Rules created by Amazon EventBridge schemas. | 
| [AWSIoTDeviceDefenderPublishFindingsToSNSMitigationAction](./policies/AWSIoTDeviceDefenderPublishFindingsToSNSMitigationAction.md) | Provides messages publish access to SNS topic for execution of PUBLISH_FINDING_TO_SNS mitigation action | 
| [AmazonQLDBConsoleFullAccess](./policies/AmazonQLDBConsoleFullAccess.md) | Provides full access to Amazon QLDB via the AWS Management Console. | 
| [AWSGlueSchemaRegistryFullAccess](./policies/AWSGlueSchemaRegistryFullAccess.md) | Provides full access to the AWS Glue Schema Registry Service | 
| [AWSServiceCatalogAppRegistryServiceRolePolicy](./policies/AWSServiceCatalogAppRegistryServiceRolePolicy.md) | Allows Service Catalog AppRegistry to manage Resource Groups on your behalf | 
| [AWSIoTFleetHubFederationAccess](./policies/AWSIoTFleetHubFederationAccess.md) | Federation access for IoT Fleet Hub applications | 
| [AmazonElasticFileSystemClientReadWriteAccess](./policies/AmazonElasticFileSystemClientReadWriteAccess.md) | Provides read and write client access to an Amazon EFS file system | 
| [AWSApplicationAutoscalingComprehendEndpointPolicy](./policies/AWSApplicationAutoscalingComprehendEndpointPolicy.md) | Policy granting permissions to Application Auto Scaling to access Comprehend and CloudWatch.  | 
| [AWSCloudShellFullAccess](./policies/AWSCloudShellFullAccess.md) | Grants using AWS CloudShell with all features | 
| [AWSIoTDeviceDefenderAddThingsToThingGroupMitigationAction](./policies/AWSIoTDeviceDefenderAddThingsToThingGroupMitigationAction.md) | Provides write access to IoT thing groups and read access to IoT Certificates for execution of ADD_THINGS_TO_THING_GROUP mitigation action | 
| [AWSIoTWirelessDataAccess](./policies/AWSIoTWirelessDataAccess.md) | Allows the associated identity data access to AWS IoT Wireless devices. | 
| [AmazonQLDBFullAccess](./policies/AmazonQLDBFullAccess.md) | Provides full access to Amazon QLDB via the service API. | 
| [AmazonAugmentedAIFullAccess](./policies/AmazonAugmentedAIFullAccess.md) | Provides access to perform all operations Amazon Augmented AI resources, including FlowDefinitions, HumanTaskUis and HumanLoops. Does not allow access for creating FlowDefinitions against the public-crowd Workteam. | 
| [AmazonKeyspacesFullAccess](./policies/AmazonKeyspacesFullAccess.md) | Provide full access to Amazon Keyspaces | 
| [AWSIoTDeviceDefenderReplaceDefaultPolicyMitigationAction](./policies/AWSIoTDeviceDefenderReplaceDefaultPolicyMitigationAction.md) | Provides write access to IoT policies for execution of REPLACE_DEFAULT_POLICY_VERSION mitigation action | 
| [AWSAppMeshReadOnly](./policies/AWSAppMeshReadOnly.md) | Provides read-only access to the AWS App Mesh APIs and Management Console. | 
| [ComputeOptimizerServiceRolePolicy](./policies/ComputeOptimizerServiceRolePolicy.md) | Allows ComputeOptimizer to call AWS services and collect workload details on your behalf. | 
| [AWSApplicationMigrationFullAccess](./policies/AWSApplicationMigrationFullAccess.md) | This policy provides permissions to all public APIs of AWS Application Migration Service (MGN), as well as permissions to read KMS key information. Attach this policy to your IAM users or roles. | 
| [AWSLakeFormationCrossAccountManager](./policies/AWSLakeFormationCrossAccountManager.md) | Provides cross account access to Glue resources via Lake Formation. Also grants read access to other required services such as organizations and resource access manager | 
| [AWSGlueDataBrewServiceRole](./policies/AWSGlueDataBrewServiceRole.md) | This policy grants permission to glue to perform action on user's glue data catalog, this policy also provides permission to ec2 actions to allow glue to create ENI to connect to resources in the VPC, also allow glue to access registered data in lakeformation and permission to access user's cloudwatch  | 
| [AmazonBraketFullAccess](./policies/AmazonBraketFullAccess.md) | Provides full access to Amazon Braket via the AWS Management Console and SDK. Also provides access to related services (e.g., S3, logs). | 
| [AWSElasticBeanstalkManagedUpdatesServiceRolePolicy](./policies/AWSElasticBeanstalkManagedUpdatesServiceRolePolicy.md) | AWS Elastic Beanstalk Service Role policy that grants limited permissions to managed updates. | 
| [AmazonLexChannelsAccess](./policies/AmazonLexChannelsAccess.md) | This policy allows customers to call Lex runtime from channels | 
| [AlexaForBusinessLifesizeDelegatedAccessPolicy](./policies/AlexaForBusinessLifesizeDelegatedAccessPolicy.md) | Provide access to Lifesize AVS devices | 
| [AmazonTimestreamReadOnlyAccess](./policies/AmazonTimestreamReadOnlyAccess.md) | Provides read only access to Amazon Timestream. Policy also provides permission to cancel any running query. If using Customer managed CMK, please refer to documentation for additional permissions needed. | 
| [AWSPanoramaFullAccess](./policies/AWSPanoramaFullAccess.md) | Provides full access to AWS Panorama | 
| [AmazonQLDBReadOnly](./policies/AmazonQLDBReadOnly.md) | Provides read only access to Amazon QLDB. | 
| [AWSChatbotServiceLinkedRolePolicy](./policies/AWSChatbotServiceLinkedRolePolicy.md) | The Service Linked Role used by AWS Chatbot. | 
| [AWSLambda_ReadOnlyAccess](./policies/AWSLambda_ReadOnlyAccess.md) | Grants read-only access to AWS Lambda service, AWS Lambda console features, and other related AWS services. | 
| [AWSCodePipeline_ReadOnlyAccess](./policies/AWSCodePipeline_ReadOnlyAccess.md) | Provides read only access to AWS CodePipeline via the AWS Management Console. | 
| [S3StorageLensServiceRolePolicy](./policies/S3StorageLensServiceRolePolicy.md) | Enables access to AWS Services and Resources used or managed by S3 Storage Lens | 
| [ServerMigrationServiceConsoleFullAccess](./policies/ServerMigrationServiceConsoleFullAccess.md) | Required permissions to use all features of the Server Migration Service Console | 
| [AWSAppSyncServiceRolePolicy](./policies/AWSAppSyncServiceRolePolicy.md) | Enables access to AWS services and resources used or managed by AppSync | 
| [AWSAppMeshFullAccess](./policies/AWSAppMeshFullAccess.md) | Provides full access to the AWS App Mesh APIs and Management Console. | 
| [AWSIncidentManagerServiceRolePolicy](./policies/AWSIncidentManagerServiceRolePolicy.md) | This policy grants Incident Manager permission to manage incident records and related resources on your behalf. | 
| [AWSProtonFullAccess](./policies/AWSProtonFullAccess.md) | Provides full access to the AWS Proton APIs and Management Console. In addition to these permissions, access to Amazon S3 is also needed to register template bundles from your S3 buckets, as well as access to Amazon IAM to create and manage the service roles for Proton. | 
| [AWSCloud9SSMInstanceProfile](./policies/AWSCloud9SSMInstanceProfile.md) | This policy will be used to attach a role on a InstanceProfile which will allow Cloud9 to use the SSM Session Manager to connect to the instance | 
| [ElementalActivationsDownloadSoftwareAccess](./policies/ElementalActivationsDownloadSoftwareAccess.md) | Access to view purchased assets and download related software and kickstart files | 
| [AWSPanoramaGreengrassGroupRolePolicy](./policies/AWSPanoramaGreengrassGroupRolePolicy.md) | Allows an AWS Lambda function on an AWS Panorama Appliance to manage resources in Panorama, upload logs and metrics to Amazon CloudWatch, and to manage objects in buckets created for use with Panorama. | 
| [AmazonDetectiveFullAccess](./policies/AmazonDetectiveFullAccess.md) |  Provides full access to Amazon Detective service and scoped access to the console UI dependencies | 
| [AWSTransferReadOnlyAccess](./policies/AWSTransferReadOnlyAccess.md) | Provide readonly access to AWS Transfer services. | 
| [ServiceQuotasReadOnlyAccess](./policies/ServiceQuotasReadOnlyAccess.md) | Provides read only access to Service Quotas | 
| [EC2FleetTimeShiftableServiceRolePolicy](./policies/EC2FleetTimeShiftableServiceRolePolicy.md) | Policy granting permissions to EC2 Fleet to launch instances in the future. | 
| [MigrationHubDMSAccessServiceRolePolicy](./policies/MigrationHubDMSAccessServiceRolePolicy.md) | Policy for Database Migration Service to assume role in customer's account to call Migration Hub | 
| [AWSServiceCatalogEndUserReadOnlyAccess](./policies/AWSServiceCatalogEndUserReadOnlyAccess.md) | Provides read-only access to Service Catalog end-user capabilities  | 
| [ElementalActivationsFullAccess](./policies/ElementalActivationsFullAccess.md) | Full access to view and take action on Elemental Appliances and Software purchased assets | 
| [AWSIQPermissionServiceRolePolicy](./policies/AWSIQPermissionServiceRolePolicy.md) | Allows AWS IQ to manage the role assumed by AWS IQ experts. | 
| [AmazonEKSForFargateServiceRolePolicy](./policies/AmazonEKSForFargateServiceRolePolicy.md) | This policy grants necessary permissions to Amazon EKS to run fargate tasks | 
| [ElementalActivationsReadOnlyAccess](./policies/ElementalActivationsReadOnlyAccess.md) | Read-only access to the detailed list of purchased assets associated to the AWS account of the user | 
| [MigrationHubSMSAccessServiceRolePolicy](./policies/MigrationHubSMSAccessServiceRolePolicy.md) | Policy for Server Migration Service to assume role in customer's account to call Migration Hub | 
| [CloudFormationStackSetsOrgAdminServiceRolePolicy](./policies/CloudFormationStackSetsOrgAdminServiceRolePolicy.md) | Service Role for CloudFormation StackSets (Organization Master Account) | 
| [AmazonEventBridgeSchemasFullAccess](./policies/AmazonEventBridgeSchemasFullAccess.md) | Provides full access to Amazon EventBridge Schemas. | 
| [AWSMarketplaceSellerFullAccess](./policies/AWSMarketplaceSellerFullAccess.md) | Provides full access to all seller operations on the AWS Marketplace and other AWS services such as AMI management. | 
| [CloudWatchAutomaticDashboardsAccess](./policies/CloudWatchAutomaticDashboardsAccess.md) | Provides access to the non-CloudWatch APIs used to display CloudWatch Automatic Dashboards, including the contents of objects such as Lambda functions | 
| [AWSDeepRacerFullAccess](./policies/AWSDeepRacerFullAccess.md) | Provides full access to AWS DeepRacer. Also provides select access to related services (e.g., S3). | 
| [AmazonWorkMailEventsServiceRolePolicy](./policies/AmazonWorkMailEventsServiceRolePolicy.md) | Enables access to AWS Services and Resources used or managed by Amazon WorkMail Events | 
| [AmazonHoneycodeTeamAssociationFullAccess](./policies/AmazonHoneycodeTeamAssociationFullAccess.md) | Provides full access to Honeycode Team Association via the AWS Management Console and the SDK.  | 
| [AmazonPrometheusRemoteWriteAccess](./policies/AmazonPrometheusRemoteWriteAccess.md) | Grants write only access to AWS Managed Prometheus workspaces | 
| [AmazonDevOpsGuruReadOnlyAccess](./policies/AmazonDevOpsGuruReadOnlyAccess.md) | Provides read only access to Amazon DevOps Guru Console. | 
| [AmazonEventBridgeSchemasReadOnlyAccess](./policies/AmazonEventBridgeSchemasReadOnlyAccess.md) | Provides read only access to Amazon EventBridge Schemas. | 
| [AmazonFISServiceRolePolicy](./policies/AmazonFISServiceRolePolicy.md) | Policy to enable AWS FIS to manage monitoring and resource selection for experiments. | 
| [AWSThinkboxDeadlineSpotEventPluginWorkerPolicy](./policies/AWSThinkboxDeadlineSpotEventPluginWorkerPolicy.md) | Grant permissions required for an EC2 instance running AWS Thinkbox Deadline Spot Event Plugin Worker software. | 
| [AWSCloudWatchAlarms_ActionSSMIncidentsServiceRolePolicy](./policies/AWSCloudWatchAlarms_ActionSSMIncidentsServiceRolePolicy.md) | This policy is used by the service-linked role named AWSServiceRoleForCloudWatchAlarms_ActionSSMIncidents. CloudWatch uses this service-linked role to perform AWS System Manager Incident Manager actions when a CloudWatch alarm goes in to ALARM state. This policy grants permission to start incidents on your behalf. | 
| [AWSIoTWirelessFullPublishAccess](./policies/AWSIoTWirelessFullPublishAccess.md) | Provides IoT Wireless full access to publish to IoT Rules Engine on your behalf. | 
| [GameLiftGameServerGroupPolicy](./policies/GameLiftGameServerGroupPolicy.md) | Policy to allow Gamelift GameServerGroups to manage customer resources | 
| [AmazonMWAAServiceRolePolicy](./policies/AmazonMWAAServiceRolePolicy.md) | The Service Linked Role used by Amazon Managed Workflows for Apache Airflow. | 
| [AmazonConnect_FullAccess](./policies/AmazonConnect_FullAccess.md) | The purpose of this policy is to grant permissions to AWS Connect users required to use Connect resources. This policy provides full access to AWS Connect resources via the Connect Console and public APIs | 
| [AWSElementalMediaLiveFullAccess](./policies/AWSElementalMediaLiveFullAccess.md) | Provides full access to AWS Elemental MediaLive resources | 
| [AWSMarketplaceSellerProductsReadOnly](./policies/AWSMarketplaceSellerProductsReadOnly.md) | Provide sellers read-only access to AWS Marketplace Management Products page. | 
| [AmazonMCSFullAccess](./policies/AmazonMCSFullAccess.md) | Provide full access to Amazon Managed Apache Cassandra Service | 
| [AWSIoTSiteWiseConsoleFullAccess](./policies/AWSIoTSiteWiseConsoleFullAccess.md) | Provides full access to manage AWS IoT SiteWise using the AWS Management Console. Note this policy also grants access to create and list data stores used with AWS IoT SiteWise (e.g. AWS IoT Analytics), access to list and view AWS IoT Greengrass resources, list and modify AWS Secrets Manager secrets, retrieve AWS IoT thing shadows, list resources with specific tags, and create and use a service-linked role for AWS IoT SiteWise. | 
| [AmazonElasticFileSystemClientFullAccess](./policies/AmazonElasticFileSystemClientFullAccess.md) | Provides root client access to an Amazon EFS file system | 
| [AWSIoTDeviceDefenderUpdateDeviceCertMitigationAction](./policies/AWSIoTDeviceDefenderUpdateDeviceCertMitigationAction.md) | Provides write access to IoT certificates for execution of UPDATE_DEVICE_CERTIFICATE mitigation action | 
| [AWSThinkboxAssetServerPolicy](./policies/AWSThinkboxAssetServerPolicy.md) | This policy grants the AWS Portal Asset Server the necessary permissions required for normal operation. | 
| [AWSForWordPressPluginPolicy](./policies/AWSForWordPressPluginPolicy.md) | Managed policy for AWS For Wordpress Plugin | 
| [AWSTransferFullAccess](./policies/AWSTransferFullAccess.md) | Provides full access to AWS Transfer Service. | 
| [AWSServiceRoleForAmazonEKSNodegroup](./policies/AWSServiceRoleForAmazonEKSNodegroup.md) | Permissions required for managing nodegroups in the customer's account. These policies related to management of the following resources: AutoscalingGroups, SecurityGroups, LaunchTemplates and InstanceProfiles. | 
| [AWSGrafanaAccountAdministrator](./policies/AWSGrafanaAccountAdministrator.md) | Provides access within Amazon Grafana to create and manage workspaces for the entire organization. | 
| [AWSBackupOperatorAccess](./policies/AWSBackupOperatorAccess.md) | This policy grants users permissions to assign AWS resources to backup plans, create on-demand backups, and restore backups. This policy does not allow the user to create or edit backup plans or to delete scheduled backups after they are created. | 
| [AWSApplicationAutoscalingLambdaConcurrencyPolicy](./policies/AWSApplicationAutoscalingLambdaConcurrencyPolicy.md) | Policy granting permissions to Application Auto Scaling to access Lambda and CloudWatch. | 
| [AWSBudgetsActionsRolePolicyForResourceAdministrationWithSSM](./policies/AWSBudgetsActionsRolePolicyForResourceAdministrationWithSSM.md) | This policy gives AWS Budgets broad permission to control AWS resources. For example, to start and stop EC2 or RDS instances by executing AWS Systems Manager (SSM) scripts. | 
| [AWSIoTDeviceDefenderUpdateCACertMitigationAction](./policies/AWSIoTDeviceDefenderUpdateCACertMitigationAction.md) | Provides write access to IoT CA certificates for execution of UPDATE_CA_CERTIFICATE mitigation action | 
| [AWSBackupServiceLinkedRolePolicyForBackupTest](./policies/AWSBackupServiceLinkedRolePolicyForBackupTest.md) | Provides AWS Backup permission to create backups on your behalf across AWS services | 
| [AWSApplicationMigrationMGHAccess](./policies/AWSApplicationMigrationMGHAccess.md) | This policy allows AWS Application Migration Service (MGN) to send meta-data about the progress of servers being migrated using MGN to AWS Migration Hub (MGH). MGN automatically creates an IAM role with this policy attached, and assumes this role. We do not recommend that you attach this policy to your IAM users or roles. | 
| [AWSDeviceFarmTestGridServiceRolePolicy](./policies/AWSDeviceFarmTestGridServiceRolePolicy.md) | Grant permissions to AWS Device Farm to call EC2 APIs on your behalf. | 
| [AmazonLookoutEquipmentFullAccess](./policies/AmazonLookoutEquipmentFullAccess.md) | Provides full access to Amazon Lookout for Equipment operations | 
| [AWSPurchaseOrdersServiceRolePolicy](./policies/AWSPurchaseOrdersServiceRolePolicy.md) | Grants permissions to view and modify purchase orders on billing console | 
| [AmazonHoneycodeTeamAssociationReadOnlyAccess](./policies/AmazonHoneycodeTeamAssociationReadOnlyAccess.md) | Provides read only access to Honeycode Team Association via the AWS Management Console and the SDK. | 
| [AmazonWorkSpacesServiceAccess](./policies/AmazonWorkSpacesServiceAccess.md) | Provides customer account access to AWS WorkSpaces service for launching a Workspace. | 
| [AWSSecurityHubOrganizationsAccess](./policies/AWSSecurityHubOrganizationsAccess.md) | Grants permission to enable and manage AWS Security Hub within an organization. Includes enabling the service across the organization, and determining the delegated administrator account for the service. | 
| [AmazonElasticFileSystemsUtils](./policies/AmazonElasticFileSystemsUtils.md) | Allows customers to use AWS Systems Manager to automatically manage Amazon EFS utilities (amazon-efs-utils) package on their EC2 instances, and use CloudWatchLog to get EFS file system mount success/failure notifications. | 
| [AWSTransferConsoleFullAccess](./policies/AWSTransferConsoleFullAccess.md) | Provides full access to AWS Transfer via the AWS Management Console | 
| [AmazonEKSServiceRolePolicy](./policies/AmazonEKSServiceRolePolicy.md) | A Service-Linked Role required for Amazon EKS to call AWS services on your behalf. | 
| [AWSIoTWirelessLogging](./policies/AWSIoTWirelessLogging.md) | Allows the associated identity to create Amazon CloudWatch Logs groups and stream logs to the groups. | 
| [AWSConfigMultiAccountSetupPolicy](./policies/AWSConfigMultiAccountSetupPolicy.md) | Allows Config to call AWS services and deploy config resources across organization | 
| [AWSIoTWirelessFullAccess](./policies/AWSIoTWirelessFullAccess.md) | Allows the associated identity full access to all AWS IoT Wireless operations. | 
| [AWSElementalMediaLiveReadOnly](./policies/AWSElementalMediaLiveReadOnly.md) | Provides read only access to AWS Elemental MediaLive resources | 
| [AmazonElasticFileSystemClientReadOnlyAccess](./policies/AmazonElasticFileSystemClientReadOnlyAccess.md) | Provides read only client access to an Amazon EFS file system | 
| [AmazonElasticMapReducePlacementGroupPolicy](./policies/AmazonElasticMapReducePlacementGroupPolicy.md) | Policy to allow EMR to create, describe and delete EC2 placement groups. | 
| [AmazonCognitoIdpServiceRolePolicy](./policies/AmazonCognitoIdpServiceRolePolicy.md) | Enables access to AWS Services and Resources used or managed by Amazon Cognito User Pools | 
| [AmazonMQServiceRolePolicy](./policies/AmazonMQServiceRolePolicy.md) | Service Linked Role Policy for AWS Amazon MQ | 
| [AWSApplicationMigrationServiceRolePolicy](./policies/AWSApplicationMigrationServiceRolePolicy.md) | Allows AWS application Migration Service to create and manage AWS resources on your behalf. | 
| [AmazonKeyspacesReadOnlyAccess](./policies/AmazonKeyspacesReadOnlyAccess.md) | Provide read only access to Amazon Keyspaces | 
| [CloudFormationStackSetsOrgMemberServiceRolePolicy](./policies/CloudFormationStackSetsOrgMemberServiceRolePolicy.md) | Service Role for CloudFormation StackSets (Organization Member Account) | 
| [AWSResourceAccessManagerResourceShareParticipantAccess](./policies/AWSResourceAccessManagerResourceShareParticipantAccess.md) | Provides access to AWS Resource Access Manager APIs needed by a resource share participant. | 
| [AWSBillingReadOnlyAccess](./policies/AWSBillingReadOnlyAccess.md) | Allows users to view bills on the Billing Console. | 
| [ServerMigrationServiceRoleForInstanceValidation](./policies/ServerMigrationServiceRoleForInstanceValidation.md) | Permissions to allow the AWS SMS to run used data validation script and send script success/failure back to SMS | 
| [AWSBackupFullAccess](./policies/AWSBackupFullAccess.md) | This policy is for backup administrators, granting full access to AWS Backup operations, including creating or editing backup plans, assigning AWS resources to backup plans, deleting backups, and restoring backups. | 
| [AmazonDevOpsGuruServiceRolePolicy](./policies/AmazonDevOpsGuruServiceRolePolicy.md) | A service-linked role required for Amazon DevOpsGuru to access your resources. | 
| [AWSElasticBeanstalkRoleWorkerTier](./policies/AWSElasticBeanstalkRoleWorkerTier.md) | (Elastic Beanstalk operations role) Allows a worker environment tier to create an Amazon DynamoDB table and an Amazon SQS queue. | 
| [AmazonCodeGuruProfilerReadOnlyAccess](./policies/AmazonCodeGuruProfilerReadOnlyAccess.md) | Provides read only access to Amazon CodeGuru Profiler. | 
| [ElementalActivationsGenerateLicenses](./policies/ElementalActivationsGenerateLicenses.md) | Access to view purchased assets and generate software licenses for pending activations | 
| [AWSAppRunnerServicePolicyForECRAccess](./policies/AWSAppRunnerServicePolicyForECRAccess.md) | AWS App Runner service policy that grants read permissions to Amazon ECR resources in the customer's account. Use it in a role that is passed to App Runner when creating or updating an App Runner service. | 
| [AWSNetworkManagerReadOnlyAccess](./policies/AWSNetworkManagerReadOnlyAccess.md) | Provides read only access to Amazon NetworkManager via the AWS Management Console. | 
| [AmazonEMRServicePolicy_v2](./policies/AmazonEMRServicePolicy_v2.md) | This policy is used for the Amazon EMR Service Role and should NOT be used for any other IAM users or roles in your account. The policy grants permissions to create and manage resources associated with EMR and related services necessary for the operation of your EMR cluster. | 
| [AWSApplicationMigrationReadOnlyAccess](./policies/AWSApplicationMigrationReadOnlyAccess.md) | This policy provides permissions to all read-only public APIs of Application Migration Service (MGN), as well as some read-only APIs of other AWS services that are required in order to make full read-only use of the MGN console. Attach this policy to your IAM users or roles. | 
| [AWSServiceCatalogAppRegistryReadOnlyAccess](./policies/AWSServiceCatalogAppRegistryReadOnlyAccess.md) | Provides read-only access to Service Catalog App Registry capabilites | 
| [AWSServiceRoleForCloudWatchAlarmsActionSSMServiceRolePolicy](./policies/AWSServiceRoleForCloudWatchAlarmsActionSSMServiceRolePolicy.md) | Provides access to Systems Manager resources used by CloudWatch Alarms | 
| [IVSRecordToS3](./policies/IVSRecordToS3.md) | Service Linked Role to perform S3 PutObject to recording IVS live streams | 
| [AmazonWorkMailMessageFlowReadOnlyAccess](./policies/AmazonWorkMailMessageFlowReadOnlyAccess.md) | Read only access to WorkMail messages for the GetRawMessageContent API | 
| [CloudWatchSyntheticsFullAccess](./policies/CloudWatchSyntheticsFullAccess.md) | Provides full access to CloudWatch Synthetics. | 
| [AWSDataExchangeSubscriberFullAccess](./policies/AWSDataExchangeSubscriberFullAccess.md) | Grants data subscriber access to AWS Data Exchange and AWS Marketplace actions using the AWS Management Console and SDK. It also provides select access to related services needed to take full advantage of AWS Data Exchange. | 
| [IAMAccessAnalyzerFullAccess](./policies/IAMAccessAnalyzerFullAccess.md) | Provides full access to IAM Access Analyzer | 
| [AWSCodeArtifactAdminAccess](./policies/AWSCodeArtifactAdminAccess.md) | Provides full access to AWS CodeArtifact via the AWS Management Console. | 
| [AWSServiceCatalogAdminReadOnlyAccess](./policies/AWSServiceCatalogAdminReadOnlyAccess.md) | Provides read-only access to Service Catalog admin capabilities  | 
| [AWSQuickSightSageMakerPolicy](./policies/AWSQuickSightSageMakerPolicy.md) | Provides access to Amazon SageMaker resources from Amazon QuickSight | 
| [AWSDataLifecycleManagerServiceRoleForAMIManagement](./policies/AWSDataLifecycleManagerServiceRoleForAMIManagement.md) | Provides appropriate permissions to AWS Data Lifecycle Manager to take actions on AWS resources for AMI Management  | 
| [AmazonMonitronFullAccess](./policies/AmazonMonitronFullAccess.md) | Provides full access to manage Amazon Monitron | 
| [AmazonHealthLakeReadOnlyAccess](./policies/AmazonHealthLakeReadOnlyAccess.md) | Provides read only access to Amazon HealthLake service. | 
| [AmazonWorkSpacesSelfServiceAccess](./policies/AmazonWorkSpacesSelfServiceAccess.md) | Provides access to Amazon WorkSpaces backend service to perform Workspace Self Service actions | 
| [AmazonManagedBlockchainServiceRolePolicy](./policies/AmazonManagedBlockchainServiceRolePolicy.md) | Enables access to AWS Services and Resources used or managed by Amazon Managed Blockchain | 
| [AmazonSageMakerCoreServiceRolePolicy](./policies/AmazonSageMakerCoreServiceRolePolicy.md) | Managed policy for Service Linked Role for Amazon SageMaker Core Services | 
| [AWSThinkboxDeadlineSpotEventPluginAdminPolicy](./policies/AWSThinkboxDeadlineSpotEventPluginAdminPolicy.md) | Grants permissions required for AWS Thinkbox's Deadline Spot Event Plugin. This includes permission to request, modify, and cancel a spot fleet, as well as limited PassRole permission. | 
| [AmazonLookoutMetricsReadOnlyAccess](./policies/AmazonLookoutMetricsReadOnlyAccess.md) | Gives access to all read-only actions for Amazon Lookout for Metrics | 
| [AWSDataExchangeFullAccess](./policies/AWSDataExchangeFullAccess.md) | Grants full access to AWS Data Exchange and AWS Marketplace actions using the AWS Management Console and SDK. It also provides select access to related services needed to take full advantage of AWS Data Exchange. | 
| [AWSDataExchangeProviderFullAccess](./policies/AWSDataExchangeProviderFullAccess.md) | Grants data provider access to AWS Data Exchange and AWS Marketplace actions using the AWS Management Console and SDK. It also provides select access to related services needed to take full advantage of AWS Data Exchange.  | 
| [CloudWatchApplicationInsightsFullAccess](./policies/CloudWatchApplicationInsightsFullAccess.md) | Provides full access to CloudWatch Application Insights and required dependencies.  | 
| [AWSControlTowerServiceRolePolicy](./policies/AWSControlTowerServiceRolePolicy.md) | Provides access to AWS Resources managed or used by AWS Control Tower  | 
| [AmazonSageMakerNotebooksServiceRolePolicy](./policies/AmazonSageMakerNotebooksServiceRolePolicy.md) | Managed policy for Service Linked Role for Amazon SageMaker Notebooks | 
| [AmazonRoute53ResolverFullAccess](./policies/AmazonRoute53ResolverFullAccess.md) | Full access policy for Route 53 Resolver | 
| [AWSSystemsManagerChangeManagementServicePolicy](./policies/AWSSystemsManagerChangeManagementServicePolicy.md) | Provides access to AWS resources managed or used by the AWS Systems Manager change management framework. | 
| [AWSServiceCatalogAppRegistryFullAccess](./policies/AWSServiceCatalogAppRegistryFullAccess.md) | Provides full access to Service Catalog App Registry capabilities | 
| [LakeFormationDataAccessServiceRolePolicy](./policies/LakeFormationDataAccessServiceRolePolicy.md) | Policy to grant temporary data access to Lake Formation resources | 
| [AmazonChimeServiceRolePolicy](./policies/AmazonChimeServiceRolePolicy.md) | Enables access to AWS Resources used or managed by Amazon Chime | 
| [AmazonSageMakerAdmin-ServiceCatalogProductsServiceRolePolicy](./policies/AmazonSageMakerAdmin-ServiceCatalogProductsServiceRolePolicy.md) | Service role policy used by the AWS Service Catalog service to provision products from Amazon SageMaker portfolio of products. Grants permissions to a set of related services including CodePipeline, CodeBuild, CodeCommit, Glue, CloudFormation, etc,. | 
| [AWSTrustedAdvisorReportingServiceRolePolicy](./policies/AWSTrustedAdvisorReportingServiceRolePolicy.md) | Service Policy for Trusted Advisor Multi-account Reporting | 
| [AWSOpsWorksRegisterCLI_EC2](./policies/AWSOpsWorksRegisterCLI_EC2.md) | Policy to enable registration of EC2 instances via the OpsWorks CLI | 
| [AWSWAFConsoleReadOnlyAccess](./policies/AWSWAFConsoleReadOnlyAccess.md) | Provides read-only access to AWS WAF via the AWS Management Console. Note that this policy also grants permissions to list Amazon CloudFront distributions, permissions to view load balancers on AWS Elastic Load Balancing, permissions to view Amazon API Gateway REST APIs and stages, permissions to list and view Amazon CloudWatch metrics, and permissions to view regions enabled within the account. | 
| [AWSSavingsPlansFullAccess](./policies/AWSSavingsPlansFullAccess.md) | Provides full access to Savings Plans service | 
| [AWSServiceRoleForImageBuilder](./policies/AWSServiceRoleForImageBuilder.md) | Allows EC2ImageBuilder to call AWS services on your behalf. | 
| [AmazonBraketServiceRolePolicy](./policies/AmazonBraketServiceRolePolicy.md) | Allows Amazon Braket to create and manage AWS resources on your behalf | 
| [AmazonCodeGuruProfilerAgentAccess](./policies/AmazonCodeGuruProfilerAgentAccess.md) | Provides access required by Amazon CodeGuru Profiler agent. | 
| [AmazonLookoutVisionConsoleFullAccess](./policies/AmazonLookoutVisionConsoleFullAccess.md) | Provides full access to Amazon Lookout for Vision and scoped access to required service and console dependencies. | 
| [AmazonCodeGuruReviewerServiceRolePolicy](./policies/AmazonCodeGuruReviewerServiceRolePolicy.md) | A service-linked role required for Amazon CodeGuru Reviewer to access resources on your behalf. | 
| [ServerMigration_ServiceRole](./policies/ServerMigration_ServiceRole.md) | Permissions to allow the AWS Server Migration Service to migrate VMs to EC2: allows the Server Migration Service to place the migrated resources into the customer's EC2 account. | 
| [AWSAppMeshPreviewEnvoyAccess](./policies/AWSAppMeshPreviewEnvoyAccess.md) | App Mesh Preview Envoy policy for accessing Virtual Node configuration. | 
| [AWSOutpostsServiceRolePolicy](./policies/AWSOutpostsServiceRolePolicy.md) | Service Linked Role policy to enable access to AWS resources managed by AWS Outposts | 
| [AmazonLambdaRolePolicyForLaunchWizardSAP](./policies/AmazonLambdaRolePolicyForLaunchWizardSAP.md) | Managed policy to support SAP provisioning using Amazon LaunchWizard service role for Lambda | 
| [AmazonEC2RoleforAWSCodeDeployLimited](./policies/AmazonEC2RoleforAWSCodeDeployLimited.md) | Provides EC2 limited access to S3 bucket to download revision. This role is needed by the CodeDeploy agent on EC2 instances.  | 
| [ECRReplicationServiceRolePolicy](./policies/ECRReplicationServiceRolePolicy.md) | Enables access to AWS Services and Resources used or managed by ECR Replication | 
| [MigrationHubServiceRolePolicy](./policies/MigrationHubServiceRolePolicy.md) | Allows Migration Hub to call Application Discovery Service on your behalf | 
| [AWSServiceRoleForMonitronPolicy](./policies/AWSServiceRoleForMonitronPolicy.md) | Grants Amazon Monitron permissions to manage AWS resources, including AWS SSO user assignment on your behalf. | 
| [AWSPanoramaSageMakerRolePolicy](./policies/AWSPanoramaSageMakerRolePolicy.md) | Allows Amazon SageMaker to manage objects in buckets created for use with AWS Panorama. | 
| [AWSIoTWirelessGatewayCertManager](./policies/AWSIoTWirelessGatewayCertManager.md) | Allows the associated identity access to create, list and describe IoT Certificates | 
| [AWSDirectConnectServiceRolePolicy](./policies/AWSDirectConnectServiceRolePolicy.md) | Provides AWS Direct Connect permission to create and manage AWS resources on your behalf. | 
| [AWSApplicationMigrationEC2Access](./policies/AWSApplicationMigrationEC2Access.md) | This policy provides Amazon EC2 operations required to use Application Migration Service (MGN) to launch the migrated servers as EC2 instances. Attach this policy to your IAM users or roles. | 
| [AWSImageBuilderReadOnlyAccess](./policies/AWSImageBuilderReadOnlyAccess.md) | Provides read only access to all AWS Image Builder actions. | 
| [AWSGrafanaConsoleReadOnlyAccess](./policies/AWSGrafanaConsoleReadOnlyAccess.md) | Access to read only operations in Amazon Grafana. | 
| [AWSMarketplaceMeteringRegisterUsage](./policies/AWSMarketplaceMeteringRegisterUsage.md) | Provides permissions to register a resource and track usage through AWS Marketplace Metering Service. | 
| [AmazonManagedBlockchainReadOnlyAccess](./policies/AmazonManagedBlockchainReadOnlyAccess.md) | Provides read-only access to Amazon Managed Blockchain. | 
| [AmazonLookoutVisionReadOnlyAccess](./policies/AmazonLookoutVisionReadOnlyAccess.md) | Provides read only access to Amazon Lookout for Vision and scoped access to required dependencies. | 
| [AmazonRekognitionCustomLabelsFullAccess](./policies/AmazonRekognitionCustomLabelsFullAccess.md) | This policy specifies rekognition and s3 permissions required by Amazon Rekognition Custom Labels feature. | 
| [AmazonHealthLakeFullAccess](./policies/AmazonHealthLakeFullAccess.md) | Provides full access to Amazon HealthLake service. | 
| [AWSBackupServiceLinkedRolePolicyForBackup](./policies/AWSBackupServiceLinkedRolePolicyForBackup.md) | Provides AWS Backup permission to create backups on your behalf across AWS services | 
| [AmazonManagedBlockchainConsoleFullAccess](./policies/AmazonManagedBlockchainConsoleFullAccess.md) | Provides full access to Amazon Managed Blockchain via the AWS Management Console | 
| [AWSApplicationMigrationConversionServerPolicy](./policies/AWSApplicationMigrationConversionServerPolicy.md) | his policy allows the Application Migration Service (MGN) Conversion Server, which are EC2 instances launched by Application Migration Service, to communicate with the MGN service. An IAM role with this policy is attached (as an EC2 Instance Profile) by MGN to the MGN Conversion Servers, which are automatically launched and terminated by MGN, when needed. We do not recommend that you attach this policy to your IAM users or roles. MGN Conversion Servers are used by Application Migration Service when users choose to launch Test or Cutover instances using the MGN console, CLI, or API. | 
| [AWSSavingsPlansReadOnlyAccess](./policies/AWSSavingsPlansReadOnlyAccess.md) | Provides read only access to Savings Plans service | 
| [AmazonHoneycodeWorkbookFullAccess](./policies/AmazonHoneycodeWorkbookFullAccess.md) | Provides full access to Honeycode Workbook via the AWS Management Console and the SDK. | 
| [AWSIoTDeviceTesterForGreengrassFullAccess](./policies/AWSIoTDeviceTesterForGreengrassFullAccess.md) | Allows AWS IoT Device Tester to run the AWS Greengrass qualification suite by allowing access to related services including Lambda, IoT, API Gateway, IAM | 
| [AWSElasticBeanstalkRoleECS](./policies/AWSElasticBeanstalkRoleECS.md) | (Elastic Beanstalk operations role) Allows a multicontainer Docker environment to manage Amazon ECS clusters. | 
| [AmazonWorkMailMessageFlowFullAccess](./policies/AmazonWorkMailMessageFlowFullAccess.md) | Full access to the WorkMail Message Flow APIs | 
| [AWSServiceRoleForSMS](./policies/AWSServiceRoleForSMS.md) | Provides access to AWS services and resources necessary to migrate service instances into AWS including EC2, S3 and Cloudformation. | 
| [AWSThinkboxDeadlineResourceTrackerAccessPolicy](./policies/AWSThinkboxDeadlineResourceTrackerAccessPolicy.md) | Grants permissions required for the operation of AWS Thinkbox's Deadline Resource Tracker. This includes full access to some EC2 actions, including DeleteFleets and CancelSpotFleetRequests. | 
| [CloudWatch-CrossAccountAccess](./policies/CloudWatch-CrossAccountAccess.md) | Allows CloudWatch to assume CloudWatch-CrossAccountSharing roles in remote accounts on behalf of the current account in order to display data cross-account, cross-region | 
| [AWSLakeFormationDataAdmin](./policies/AWSLakeFormationDataAdmin.md) | Grants administrative access to AWS Lake Formation and related services, such as AWS Glue, to manage data lakes | 
| [AWSElasticBeanstalkRoleCore](./policies/AWSElasticBeanstalkRoleCore.md) | AWSElasticBeanstalkRoleCore (Elastic Beanstalk operations role) Allows core operation of a web service environment. | 
| [AWSLambda_FullAccess](./policies/AWSLambda_FullAccess.md) | Grants full access to AWS Lambda service, AWS Lambda console features, and other related AWS services. | 
| [AmazonEMRContainersServiceRolePolicy](./policies/AmazonEMRContainersServiceRolePolicy.md) | Allows access to other AWS service resources that are required to run Amazon EMR | 
| [AWSDenyAll](./policies/AWSDenyAll.md) | Deny all access. | 
| [AWSIQFullAccess](./policies/AWSIQFullAccess.md) | Provides full access to AWS IQ | 
| [AmazonElasticContainerRegistryPublicPowerUser](./policies/AmazonElasticContainerRegistryPublicPowerUser.md) | Provides full access to Amazon ECR Public repositories, but does not allow repository deletion or policy changes. | 
| [AmazonPrometheusConsoleFullAccess](./policies/AmazonPrometheusConsoleFullAccess.md) | Grants full access to AWS Managed Prometheus resources in the AWS console | 
| [AWSElasticBeanstalkRoleSNS](./policies/AWSElasticBeanstalkRoleSNS.md) | (Elastic Beanstalk operations role) Allows an environment to enable Amazon SNS topic integration. | 
| [AmazonEKSVPCResourceController](./policies/AmazonEKSVPCResourceController.md) | Policy used by VPC Resource Controller to manage ENI and IPs for worker nodes. | 
| [EC2InstanceConnect](./policies/EC2InstanceConnect.md) | Allows customers to call EC2 Instance Connect to publish ephemeral keys to their EC2 instances and connect via ssh or the EC2 Instance Connect CLI. | 
| [AWSCompromisedKeyQuarantineV2](./policies/AWSCompromisedKeyQuarantineV2.md) | Denies access to certain actions, applied by the AWS team in the event that an IAM user's credentials have been compromised or exposed publicly. Do NOT remove this policy. Instead, please follow the instructions specified in the support case created for you regarding this event. | 
| [ClientVPNServiceConnectionsRolePolicy](./policies/ClientVPNServiceConnectionsRolePolicy.md) | Policy to enable AWS Client VPN to manage your Client VPN endpoint connections. | 
| [AmazonAppFlowFullAccess](./policies/AmazonAppFlowFullAccess.md) | Provides full access to Amazon AppFlow and access to AWS services supported as flow source or destination (S3 and Redshift). Also provides access to KMS for encryption | 
| [Ec2ImageBuilderCrossAccountDistributionAccess](./policies/Ec2ImageBuilderCrossAccountDistributionAccess.md) | Permissions need by EC2 Image Builder to perform a cross account distribution. | 
| [AWSThinkboxAWSPortalWorkerPolicy](./policies/AWSThinkboxAWSPortalWorkerPolicy.md) | This policy grants the Deadline Workers in AWS Portal the necessary permissions required for normal operation. | 
| [AmazonS3OutpostsReadOnlyAccess](./policies/AmazonS3OutpostsReadOnlyAccess.md) | Provides read only access to Amazon S3 on Outposts via the AWS Management Console. | 
| [AWSCompromisedKeyQuarantine](./policies/AWSCompromisedKeyQuarantine.md) | Denies access to certain actions, applied by the AWS team in the event that an IAM user's credentials have been compromised or exposed publicly. Do NOT remove this policy. Instead, please follow the instructions specified in the email sent to you regarding this event. | 
| [AWSAppMeshEnvoyAccess](./policies/AWSAppMeshEnvoyAccess.md) | App Mesh Envoy policy for accessing Virtual Node configuration. | 
| [AmazonKendraReadOnlyAccess](./policies/AmazonKendraReadOnlyAccess.md) | Provides read only access to Amazon Kendra via the AWS Management Console. | 
| [AmazonPrometheusFullAccess](./policies/AmazonPrometheusFullAccess.md) | Grants full access to AWS Managed Prometheus resources | 
| [AWS_ConfigRole](./policies/AWS_ConfigRole.md) | Default policy for AWS Config service role. Provides permissions required for AWS Config to track changes to your AWS resources. | 
| [AmazonNimbleStudio-StudioAdmin](./policies/AmazonNimbleStudio-StudioAdmin.md) | This policy grants access to Amazon Nimble Studio resources associated with the studio admin and related studio resources in other services. Attach this policy to the Admin role associated with your studio. | 
| [AWSCodeArtifactReadOnlyAccess](./policies/AWSCodeArtifactReadOnlyAccess.md) | Provides read only access to AWS CodeArtifact via the AWS Management Console. | 
| [AmazonRedshiftDataFullAccess](./policies/AmazonRedshiftDataFullAccess.md) | This policy provides full access to Amazon Redshift Data APIs. This policy also grants scoped access to other required services. | 
| [AWSApplicationMigrationReplicationServerPolicy](./policies/AWSApplicationMigrationReplicationServerPolicy.md) | This policy allows the Application Migration Service (MGN) Replication Servers, which are EC2 instances launched by Application Migration Service - to communicate with the MGN service, and to create EBS snapshots in your AWS account. An IAM role with this policy is attached (as an EC2 Instance Profile) by Application Migration Service to the MGN Replication Servers which are automatically launched and terminated by MGN, as needed. MGN Replication Servers are used to facilitate data replication from your external servers to AWS, as part of the migration process managed using MGN. We do not recommend that you attach this policy to your IAM users or roles. | 
